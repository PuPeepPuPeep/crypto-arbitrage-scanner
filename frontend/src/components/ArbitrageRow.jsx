    ...
    return (
        <tr className="bg-gray-900 hover:bg-gray-700">
            ...
            <td className={
                ...
                "text-green-400 text-right font-mono border border-gray-700" :
                row.bitkub_price > row.binance_price_thb ?
                "text-red-400 text-right font-mono border border-gray-700" :
                "text-right font-mono border border-gray-700"
            }>
